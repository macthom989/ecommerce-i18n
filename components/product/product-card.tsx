    ...
    <div
      className={cn(
        `group box-border overflow-hidden flex ${!disableBorderRadius && 'rounded-md'} cursor-pointer`,
        {
          ...
          'ltr:pr-0 rtl:pl-0 md:pb-1 flex-col items-start': variant === 'gridSlim',
      ...
      >
        {(variant === 'gridModern' || variant === 'gridModernWide' || variant === 'gridTrendy') && (
          <div className="flex items-center py-2 gap-x-2">
            ...
            <span className="text-xs font-semibold truncate sm:text-sm text-heading">4.5</span>
            {product.quantity === 0 && (
        ...
        {!!(showCategory || showRating) && (
          <div className="flex flex-col md:flex-row md:items-center lg:flex-row xl:flex-row 2xl:flex-row  mb-0.5 items-start">
            {!!showCategory && (
              <h3
                className={cn('font-semibold text-sm mb-1 md:mb-0 ltr:mr-2 rtl:ml-2 ltr:md:mr-3 rtl:md:ml-3', {
        ...
        {!hideProductDescription && product?.short_description && (
          <p
