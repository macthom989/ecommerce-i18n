...
import { SignUpInputType, useSignUpMutation } from '@services/auth/use-sign-up';
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col justify-center" noValidate>
        <div className="flex flex-col space-y-4">
          ...
          <div className="relative">
            <Button type="submit" loading={isPending} disabled={isPending} className="h-11 md:h-12 w-full mt-2">
