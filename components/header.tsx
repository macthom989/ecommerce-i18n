    ...
    },
    {
      ...
      subItems: [
        ...
        },
        {
          ...
          items: [
            { href: "/men/wedding-collect", label: "Wedding Collect" },
          ],
        },
        {
    ...
    },
    {
      ...
      subItems: [
        ...
        },
        {
          title: "Plus Size",
          items: [
            { href: "/women/plus-size", label: "Plus Size" },
          ],
        },
        {
          title: "Sunglasses & Frames",
          items: [
            { href: "/women/sunglasses", label: "Sunglasses & Frames" },
          ],
        },
      ],
    ...
    },
    {
      ...
      subItems: [
        ...
        },
        {
          ...
          items: [
            { href: "/pages/belts-scarves", label: "Belts, Scarves & More" },
          ],
        },
        {
          title: "Makeup",
          ...
          <NavigationMenuList>
            {navItems.map((item) => {
              return <NavigationMenuItem key={item.href} >
                {item.subItems? (
                  <>
                    <NavigationMenuTrigger onMouseEnter={()=>{console.log(item);setOpenMenu(item.href)}}>{item.label}</NavigationMenuTrigger>
