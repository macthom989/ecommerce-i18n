export default function WishButton() {
  return (
    ...
    >
      ...
      <span
        className="cart-counter-badge flex items-center justify-center bg-heading text-white absolute -top-2.5 xl:-top-3 ltr:-right-2.5 ltr:xl:-right-3 rtl:-left-2.5 rtl:xl:-left-3 rounded-full font-bold">
        0
      </span>
    </button>
  );
